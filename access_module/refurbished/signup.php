...
note: ejah balik template HTML untuk UI(gk balik)

status: function settle, ui not 100% yet refer note
!-->
...
if(isset($_POST['btn-signup']))
{
	...
	else
	{
		...
		{			
			...
			$subject = "UmmahFund : Thank you for registering with us!";
...
<html>
  <head>
    <title>Signup - UmmahFund (alpha)</title>
    <!-- Bootstrap -->
