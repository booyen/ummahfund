...
{
	$uname = trim($_POST['register-username']);
	$email = trim($_POST['register-email']);
	$upass = trim($_POST['register-password']);
	...
	{
		if($reg_user->register($uname,$email,$upass,$code,$utype))
		{			
			//email link token
            $id = $reg_user->lasdID();		
                                      ...
                                      <tr>
                                        <td bgcolor="#ffffff" align="center" style="padding: 0px 30px 0px 30px; color: #666666; font-size: 18px; font-weight: 400; line-height: 25px;" >
                                          <p style="margin: 0;">Jika button diatas tidak berfungsi, sila copy dan paste link dibawah ke url browser anda</p>
                                           ...
                                           http://localhost/uf/uf/access_module/base_pages_verify.php?id='.$id.'&code='.$code.'</p>
        ...
        <div class="content content-boxed overflow-hidden">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                    <div class="push-20-t push-20 animated fadeIn">
                        <!-- Register Title -->
                        ...
                        <form class="js-validation-register form-horizontal push-50-t push-50"  method="post">
                            ...
                            <div class="form-group">
                             <div class="col-xs-12 text-center">
                                            ...
                                            <label for="register-usertype">Which one are you?</label><br>
                                            <label class="css-input css-radio css-radio-success push-10-r">
                                                <input type="radio" name="userType" value="D" checked ><span></span> Donor
                                            </label>
                                            <label class="css-input css-radio css-radio-success">
                                                <input type="radio" name="userType" value="O"><span></span> Organization
                                            </label>
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent remove-margin-b">
                    ...
                    <div class="block-content">
                        <p>
                        Last Revised: December 16, 2016<br>

Welcome to UmmahFund This site is provided as a service to our visitors and may be used for informational purposes only. Because the Terms and Conditions contain legal obligations, please read them carefully.<br>
